...
struct JapaneseWritingListView: View {
    ...
    let beginnerCourses: [JapaneseCourse] = [
        JapaneseCourse(title: "Hiragana", subtitle: "Practice Hiragana Writing", iconName: "pencil.and.scribble"), // ikon yang lebih sesuai
        JapaneseCourse(title: "Katakana", subtitle: "Practice Katakana Writing", iconName: "pencil.and.scribble"), // ikon yang lebih sesuai
        JapaneseCourse(title: "Kanji N5 - Writing", subtitle: "Practice JLPT N5 Kanji", iconName: "character.ja") // ikon baru untuk kanji
    ]
    ...
    var body: some View {
        // TIDAK ADA NavigationView di sini jika ini di-push oleh NavigationView lain
        VStack(alignment: .leading) {
            ...
            ScrollView {
                VStack(spacing: 15) { // Jarak antar kartu
                ...
                // .padding(.horizontal) // Hapus ini karena JapaneseWritingView sudah punya .padding(.horizontal) sendiri
            }
            .frame(maxWidth: .infinity, maxHeight: .infinity)
            .background(Color(UIColor.systemBackground))
        }
        .background(Color(UIColor.systemBackground).ignoresSafeArea())
        // .navigationTitle("Writing Practice") // Gunakan jika ingin judul di Nav Bar
        ...
        var body: some View {
            ForEach(courses) { course in
                NavigationLink(
                    ...
                    // Pastikan nama struct ini (JapaneseWritingView) sesuai dengan
                    // yang didefinisikan di file JapaneseWritingCourseCardView.swift
...
#Preview {
    NavigationView { // Dibutuhkan untuk preview NavigationLink

...
struct CarouselView: View {
    ...
    private func destinationView(for cardTitle: String) -> some View {
        switch cardTitle {
        case "Grammar":
            JapaneseGrammarListView() // <<< TAMBAHKAN INI
        case "Writing":
            JapaneseWritingListView() // Ini adalah View Writing yang sudah kita buat //
        case "Quiz":
            Text("Quiz Page (Coming Soon)") // Ganti dengan View Quiz Anda //
        case "FlashCard":
            JapaneseFlashCardListView() // Ganti dengan View FlashCard Anda //
        default:

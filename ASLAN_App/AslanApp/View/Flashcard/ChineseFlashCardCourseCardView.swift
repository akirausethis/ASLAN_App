// JapaneseFlashCardView.swift
import SwiftUI

struct JapaneseFlashCardView: View {
...
#Preview {
    JapaneseFlashCardView(course: JapaneseCourse(title: "Hiragana", subtitle: "Let's start your Journey!", iconName: "doc.text.fill"), isSelected: false)

// HiraganaFlashcardCarouselView.swift
import SwiftUI

// MARK: - HiraganaFlashcardCarouselView
struct HiraganaFlashcardCarouselView: View {
    @Environment(\.presentationMode) var presentationMode
    
    @State private var availableFlashcards: [HiraganaFlashcard] = HiraganaFlashcard.allHiragana.shuffled()
    
    @State private var currentFlashcard: HiraganaFlashcard?

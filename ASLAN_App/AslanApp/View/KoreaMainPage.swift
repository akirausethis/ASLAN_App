...
struct LanguageCourseCardView: View {
    ...
    private func iconName(for title: String) -> String {
        ...
        default:
            return "graduationcap.fill" // Default icon
        }
    }
}


struct KoreanMainPageView_Previews: PreviewProvider { // Diubah dari JapaneseMainPageView_Previews
    static var previews: some View {
        KoreanMainPageView() // Diubah dari JapaneseMainPageView()
    }
}

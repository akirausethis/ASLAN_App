    ...
    private struct QuizCourseItemsView: View {
        ...
        var body: some View {
            ForEach(courses) { course in
                // Memastikan NavigationLink membungkus keseluruhan card untuk area tap yang lebih besar
                NavigationLink(
                ...
                .buttonStyle(PlainButtonStyle()) // Penting agar visual tombol tidak mengganggu tap area
            }
        }
    }
...
#Preview {
    // Preview di sini membutuhkan NavigationStack juga
    NavigationStack { //
